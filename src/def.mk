...
LIBS += $(OPTIMIZE) -rdynamic -lstdc++ -lpthread -lz $(LINKARGS)
...
#for libs
#for libs
$(LIBRUM_A): $(OBJS_C) $(OBJS_CXX)
	$(AR) -rcs $@ $(OBJS_C) $(OBJS_CXX)

$(LIBRUM_S_SO): $(OBJS_C)
	$(CC) -shared -o $@ -Wl,-soname,$(LIBRUM_S_SO) $(OBJS_C)

$(LIBRUM_X_SO): $(OBJS_CXX)
	$(CC) -shared -o $@ -Wl,-soname,$(LIBRUM_X_SO) $(OBJS_CXX)
